...
const gameConfig = {
    imagePaths: {
        ...
        8: 'img/stage2-8.png',
        9: 'img/stage2-9.png',
        10: 'img/stage2-10.png',
        11: 'img/stage2-11.png',
        12: 'img/stage2-12.png',
    },
    correctAnswers: {
        "right-hand": "楊柳枝",
        "left-hand": "淨瓶",
...
function checkAnswers() {
    ...
    alert("完全正確喔!我們來從觀音看台灣的普偏的信仰文化吧。");
    return true;
}
...
function checkInputAnswer() {
    ...
    if (inputValue.includes("coast")) { // 修改為判斷是否包含 coast
        alert('完全正確，你對東南亞的宗教信仰已有初步的認識囉!');
        return true;
    } else {
...
nextBtn.addEventListener('click', () => {
    if (currentImageIndex === gameConfig.totalImages) {
        window.location.href = 'https://guidephy.github.io/internationalFriend/coast.html';
        return;
    }
